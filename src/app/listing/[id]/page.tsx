...
// Browse page owns the full listing fixtures array for cross-page consistency.
// This page uses slugified IDs that match browse fixtures.
const SAMPLE_FABRICS: (FabricRow & { factory: FactoryRow })[] = [
  {
    id: "italian-wool-flannel",
    title: "Italian Wool Flannel",
    material: "Wool",
    weave_type: "Flannel",
    color_family: "Forest",
    price_per_yard: 42,
    yards_available: 18.5,
    width_inches: 58,
    weight_gsm: 340,
    factory_id: "lanificio-roma",
  ...
  {
    id: "french-linen-natural",
    title: "French Linen Natural",
    material: "Linen",
    weave_type: "Plain",
    ...
    width_inches: 54,
    weight_gsm: 180,
    factory_id: "atelier-normandie",
    image_url: "/images/feature-2.webp",
    ai_confidence: 92,
    status: "active",
    created_at: new Date().toISOString(),
    factory: {
      id: "atelier-normandie",
      name: "Atelier Normandie",
      location: "Rouen",
      country: "France",
